...
<div class="content-header">
    <h4 class="content-title">
        ...
        <span>Master Akses/Keamanan Surat</span>
    </h4>
</div>
<div class="content-body">
    ...
    <div class="card mb-4">
        <div class="card-header bg-white border-bottom">
            <div>
                <h5 class="card-title mb-0">Daftar Akses/Keamanan Surat</h5>
            </div>
            ...
            <?php if(auth()->hasPermission('entri_akses')) { ?>
            <div>
                <a href="<?= route('entri_akses') ?>" class="btn btn-primary"><i class="fa-solid fa-plus me-2"></i>Add</a>
            </div>
            <?php } ?>
        </div>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td width="70" class="text-center"><?= $row['kode'] ?></td>
                            <td><?= $row['nama'] ?></td>
                            <?php if (auth()->hasPermission('edit_akses') && auth()->hasPermission('delete_akses')) { ?>
                                <td width="210" class="text-center">
                                    <div>
                                        <!-- button form ubah data -->
                                        <a href="<?= base_url('/akses/edit/' . $row['kode']) ?>" class="btn btn-success btn-xs"> <i class="fa-solid fa-pencil me-1"></i> Ubah </a>
                                        <!-- button modal hapus data -->
                                        <button type="button" class="btn btn-danger btn-xs" data-bs-toggle="modal" data-bs-target="#modalHapus<?= $row['kode']; ?>"> <i class="fa-solid fa-trash-can me-1"></i> Hapus </button>
                                        <!-- Modal hapus data -->
                                        <div class="modal fade" id="modalHapus<?= $row['kode'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalHapusLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel">
                                                            <i class="fa-regular fa-trash-can me-2"></i> Hapus Data Keamanan/Akses Naskah Dinas
                                                        </h1>
                                                    </div>
                                                    <div class="modal-body text-start">
                                                        <p class="mb-2">Anda yakin ingin menghapus data keamanan/akses ini?</p>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="<?= base_url('/akses/delete/' . $row['kode'])  ?>" class="btn btn-danger rounded-pill px-3">Ya, Hapus</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
