...
use Core\Helper\Url;
$pagination = MemoKeluarModel::pager();
...
<div class="content-body">
    ...
    <div class="card mb-4">
        <div class="card-header bg-white border-bottom">
            <div>
                <h5 class="card-title mb-0">Daftar Memorandum Keluar</h5>
            </div>
            ...
            <div>
                <a href="<?= route('entri_memo_keluar') ?>" class="btn btn-primary"><i class="fa-solid fa-plus me-2"></i>Add</a>
            </div>
        </div>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="align-items-center">
                                    <?php if ($row['file']) { ?>
                                        File : <a target="_blank" href="<?= upload("/{$tahun}/memo_keluar/" . $row['file']) ?>"><i class="fa-solid fa-file-pdf"></i></a>
                                    <?php } ?>
                                </div>
                            </td>
                            ...
                            <td width="210" class="text-center">
                                <div>
                                    ...
                                    <a href="<?= route('edit_memo_keluar') . $row['id'] ?>" class="btn btn-success btn-xs"> <i class="fa-solid fa-pencil me-1"></i> Ubah </a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="<?= route('delete_memo_keluar') . $row['id'] ?>" class="btn btn-danger rounded-pill px-3">Ya, Hapus</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
