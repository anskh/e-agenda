...
use Core\Helper\Url;
$pagination = EksternalKeluarModel::pager();
...
<div class="content-header">
    <h4 class="content-title">
        ...
        <span>Undangan Eksternal Keluar</span>
    </h4>
</div>
<div class="content-body">
    ...
    <div class="card mb-4">
        <div class="card-header bg-white border-bottom">
            <div>
                <h5 class="card-title mb-0">Daftar Undangan Eksternal Keluar</h5>
            </div>
            ...
            <div>
                <a href="<?= route('entri_eksternal_keluar') ?>" class="btn btn-primary"><i class="fa-solid fa-plus me-2"></i>Add</a>
            </div>
        </div>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <div>
                                    <?php if ($row['file']) { ?>
                                        File : <a target="_blank" href="<?= upload("/{$tahun}/eksternal_keluar/" . $row['file']) ?>"><i class="fa-solid fa-file-pdf"></i></a>
                                    <?php } ?>
                                </div>
                            </td>
                            ...
                            <td width="210" class="text-center">
                                <div>
                                    ...
                                    <a href="<?= route('edit_eksternal_keluar') . $row['id'] ?>" class="btn btn-success btn-xs"> <i class="fa-solid fa-pencil me-1"></i> Ubah </a>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">
                                                        <i class="fa-regular fa-trash-can me-2"></i> Hapus Undangan Eksternal Keluar
                                                    </h1>
                                                </div>
                                                <div class="modal-body text-start">
                                                    <p class="mb-2">Anda yakin ingin menghapus undangan Eksternal keluar ini?</p>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="<?= route('delete_eksternal_keluar') . $row['id'] ?>" class="btn btn-danger rounded-pill px-3">Ya, Hapus</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
