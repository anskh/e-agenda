...
if ($model->isEdit()) {
    $action = route('edit_klasifikasi') . $model->kode;
} else {
    $action = route('entri_klasifikasi');
}
?>
<div class="content-body">
    <div class="card mb-5 col-xl-8">
        ...
        <div class="card-body">
            <h4 class="card-title py-1 mb-5"><?= $model->isEdit() ? 'Ubah ' : 'Tambah ' ?>Klasifikasi</h4>
            <?php
            if ($model->hasError()) { ?>
        ...
        <div class="card-footer text-end">
            ...
            <a href="<?= route('klasifikasi') ?>" class="btn btn-secondary rounded-pill py-2 px-4">Batal</a>
            <!-- button simpan data -->
