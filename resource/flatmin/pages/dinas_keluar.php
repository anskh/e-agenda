...
use Core\Helper\Url;
$pagination = DinasKeluarModel::pager();
...
<div class="content-body">
    ...
    <div class="card mb-4">
        <div class="card-header bg-white border-bottom">
            <div>
                <h5 class="card-title mb-0">Daftar Surat Dinas Keluar</h5>
            </div>
            ...
            <div>
                <a href="<?= route('entri_dinas_keluar') ?>" class="btn btn-primary"><i class="fa-solid fa-plus me-2"></i>Add</a>
            </div>
        </div>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <div>
                                    <?php if ($row['file']) { ?>
                                        File : <a target="_blank" href="<?= upload("/{$tahun}/dinas_keluar/" . $row['file']) ?>"><i class="fa-solid fa-file-pdf"></i></a>
                                    <?php } ?>
                                </div>
                            </td>
                            ...
                            <td width="210" class="text-center">
                                <div>
                                    ...
                                    <a href="<?= route('edit_dinas_keluar') . $row['id'] ?>" class="btn btn-success btn-xs"> <i class="fa-solid fa-pencil me-1"></i> Ubah </a>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">
                                                        <i class="fa-regular fa-trash-can me-2"></i> Hapus Surat Dinas Keluar
                                                    </h1>
                                                </div>
                                                <div class="modal-body text-start">
                                                    <p class="mb-2">Anda yakin ingin menghapus surat dinas keluar ini?</p>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="<?= route('delete_dinas_keluar') . $row['id'] ?>" class="btn btn-danger rounded-pill px-3">Ya, Hapus</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
